...
HuffChunkLoop:
  ...
  HuffByteLoop: 
    ...
    HuffBranch:
      ...
      j HuffNodeEnd
      ori t5,r0,0x40 ; T5 = Test Node1 End Flag (Delay Slot)
      HuffNode0:
        ori t5,r0,0x80 ; T5 = Test Node0 End Flag
      HuffNodeEnd:
        and t5,t4 ; Test Node End Flag (1 = Next Child Node Is Data)
        beqz t5,HuffByteLoop
        nop ; Delay Slot
        j HuffByteLoop

; PSX 'Bare Metal' GPU 16BPP Render Clipped Polygon Demo by krom (Peter Lemon):
.psx
.create "RenderPolygonClip16BPP.bin", 0x80010000
...
DrawingArea 0,0, 319,239; Set Drawing Area: X1,Y1, X2,Y2
WRGP0 GPUDRAWOFS,0x000000 ; Write GP0 Command Word (Set Drawing Offset X=0, Y=0)

; Render Polygons
DrawingArea 40,24, 88,64; Set Drawing Area: X1,Y1, X2,Y2
...
DrawingArea 128,38, 192,48; Set Drawing Area: X1,Y1, X2,Y2
...
DrawingArea 240,8, 272,80; Set Drawing Area: X1,Y1, X2,Y2
...
DrawingArea 43,97, 277,133; Set Drawing Area: X1,Y1, X2,Y2
...
DrawingArea 40,172, 204,188; Set Drawing Area: X1,Y1, X2,Y2
...
DrawingArea 235,157, 277,193; Set Drawing Area: X1,Y1, X2,Y2

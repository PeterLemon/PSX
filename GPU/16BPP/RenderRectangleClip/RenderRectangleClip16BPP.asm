; PSX 'Bare Metal' GPU 16BPP Render Clipped Rectangle Demo by krom (Peter Lemon):
.psx
.create "RenderRectangleClip16BPP.bin", 0x80010000
...
; Render Rectangles
DrawingArea 43,17, 277,53; Set Drawing Area: X1,Y1, X2,Y2
...
; Tight fit round both pixels
DrawingArea 85,52, 85,72; Set Drawing Area: X1,Y1, X2,Y2
...
; Extend drawing area one pixel in +x and +y
DrawingArea 181,52, 182,73; Set Drawing Area: X1,Y1, X2,Y2
...
; Extend drawing area one pixel in -x and -y
DrawingArea 276,51, 277,72; Set Drawing Area: X1,Y1, X2,Y2
...
DrawingArea 34,94, 234,102; Set Drawing Area: X1,Y1, X2,Y2
...
DrawingArea 36,130, 244,146; Set Drawing Area: X1,Y1, X2,Y2
